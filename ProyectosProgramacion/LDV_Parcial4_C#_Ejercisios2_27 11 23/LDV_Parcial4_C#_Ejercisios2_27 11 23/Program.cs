...
namespace Ejersicios
{
    class Program
    {
        ...
        static float Ejercisio1(float flot1,float flot2)
        {
            Double superRes;
            try
            {
                superRes = Math.Pow(flot1, 0.5f);
                flot2 = (float)superRes;
            }
            catch
            {
        ...
        static bool Ejercisio2(string pInpt,bool val1b,bool val2b,char val1c,string val1s)
        {
            while (true)
            {
        ...
        static void Ejercisio3(float val1f, float val2f, float val3f)
        {
            val1f = 0;
            val2f = 0;
            val3f = 1;
        ...
        static void Ejercisio4(float val1f, float val2f, float val3f)
        {
            string val1s = "";
        ...
        static void Ejercisio5(float val1f, float val2f)
        {
            val1f = 0;
            val2f = 1;
            string val1s = "";
        ...
        static void Main()
        {
            ...
            Console.WriteLine("-- Tu indice de masa corporal es " + Ejercisio1(val1f,val2f));
            ...
            if (Ejercisio2(pInpt,val1b,val2b,val1c,val1s) == true)
            {
            ...
            Ejercisio3(val1f, val2f, val3f);

            Console.WriteLine("--- Ejercisio 4 ---");
            Ejercisio4(val1f, val2f,val3f);

            Console.WriteLine("--- Ejercisio 5 ---");
            Ejercisio5(val1f, val2f);
